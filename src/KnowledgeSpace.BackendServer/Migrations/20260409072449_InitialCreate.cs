        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastCollected = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrashBins_Wards_WardId",
                        column: x => x.WardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGreenPoints = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    WardId = table.Column<int>(type: "int", nullable: true),
                    LeaderId = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAfterUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportProgress_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReportProgress_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGreenPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGreenPoints_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGreenPoints_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportProgress_ReportId",
                table: "ReportProgress",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportProgress_UpdatedBy",
                table: "ReportProgress",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrashBins_WardId",
                table: "TrashBins",
                column: "WardId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGreenPoints_ReportId",
                table: "UserGreenPoints",
                column: "ReportId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGreenPoints_UserId",
                table: "UserGreenPoints",
                column: "UserId");
